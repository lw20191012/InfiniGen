...
do
  ...
  CMD="--model $MODEL_PATH --path /home/liuwang/opt_weights --offload-dir /home/liuwang/flexgen_offload_dir --percent 100 0 0 100 100 0 --overlap false --gpu-batch-size 8 --num-gpu-batches 1 --prompt-len 1920 --gen-len 128 --warmup-input-path pg19_firstbook.txt --test-input-path pg19_firstbook.txt"
